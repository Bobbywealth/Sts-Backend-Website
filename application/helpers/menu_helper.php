...
function app_init_admin_sidebar_menu_items()
{
    ...
    // if ((has_permission('eviction', '', 'view') || has_permission('eviction', '', 'view_own'))
    // ) {
    //     $CI->app_menu->add_sidebar_children_item('orders', [
    //         'slug'     => 'eviction',
    //         'name'     => _l('Eviction Filling Orders'),
    //         'href'     => admin_url('order'),
    //         'position' => 5,
    //         'badge'    => []
    //     ]);
    // }
    // if ((has_permission('physical', '', 'view') || has_permission('physical', '', 'view_own'))
    // ) {
    //     $CI->app_menu->add_sidebar_children_item('orders', [
    //         'slug'     => 'physical',
    //         'name'     => _l('Physical Eviction Orders'),
    //         'href'     => admin_url('order/physical_order'),
    //         'position' => 5,
    //         'badge'    => []
    //     ]);
    // }
    // if ((has_permission('other', '', 'view') || has_permission('other', '', 'view_own'))
    // ) {
    //     $CI->app_menu->add_sidebar_children_item('orders', [
    //         'slug'     => 'other',
    //         'name'     => _l('Other Services Orders'),
    //         'href'     => admin_url('order/other_order'),
    //         'position' => 5,
    //         'badge'    => []
    //     ]);
    // }
