...
/* Custome profile eviction  order table */

initDataTable('.table-order-single-client', admin_url + 'order/table/' + customer_id, undefined, undefined, 'undefined', <?php echo hooks()->apply_filters('projects_table_default_order', json_encode(array(5,'asc'))); ?>);
     /* Custome profile physical order table */
     initDataTable('.table-order-physical-single-client', admin_url + 'order/physical_table/' + customer_id, undefined, undefined, 'undefined', <?php echo hooks()->apply_filters('projects_table_default_order', json_encode(array(5,'asc'))); ?>);
     /* Custome profile other order table */
     initDataTable('.table-order-other-single-client', admin_url + 'order/other_table/' + customer_id, undefined, undefined, 'undefined', <?php echo hooks()->apply_filters('projects_table_default_order', json_encode(array(5,'asc'))); ?>);
