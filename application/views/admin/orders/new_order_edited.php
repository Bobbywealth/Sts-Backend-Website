      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
            <h4 class="no-margin"> Eviction Filling</h4>
            <hr class="hr-panel-heading" />
            <div id="svg_wrap"></div>
            <hr class="hr-panel-heading" />
            <?php echo form_open_multipart($this->uri->uri_string(''), array('id' => 'eviction_filling_admin',));
           $client_id = $this->input->get('client_id', TRUE);
           ?>

            <section id="eviction_filling_admin_a">
              <h4 class="text-center">Owner's information</h4> <br />
              
                <div class="col-sm-12">
                  <?php  if(is_null($customer_id)){
                  echo render_select('client_id', $custumer, ['userid', 'company'], _l('Select Costumer *'),);
                }
                if($customer_id){
              ...
              <div class="col-md-6">
                <?php
                echo render_input('o_fname', 'Tenant First Name *', '', '', ['placeholder' => 'Tenant First Name *'], [], '', '');
                ?>
              </div>

              <div class="col-md-6">
                <?php
                echo render_input('o_lname', 'Tenant Last Name *', '', '', ['placeholder' => 'Tenant Last Name *']);
                ?>
              </div>
              ...
              <div class="col-md-6">
                ...
                echo render_input('o_scontact', 'Date of Birth *', '', '', ['placeholder' => 'Date of Birth *']);
              ...
              <div class="col-sm-6">
                ...
                // echo render_input('o_bilal', 'Bilal *', '', '', ['placeholder' => 'Bilal *']);
             ...
             <div class="col-sm-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <?php 
                echo render_input('p_inspection_number', '', '', '', ['placeholder' => 'Unit  Number']);
                  ?>
                </div>

                <div class="col-md-4">
                <?php 
                echo render_select('t_property_govt_confirm', array(['id' => 'Yes', 'name' => 'Oral'], ['id' => 'No', 'name' => 'Written']), ['id', 'name'], _l('What type of lease? '),);
                echo render_input('c_monthly_rent', 'Monthly Rent Amount: *', '', '', ['placeholder' => 'Monthly Rent Amount']);
                ?>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                <?php
                echo render_input('t_dob_two', 'When was the notice delivered to the defendant(s)', '', 'date', ['placeholder' => 'When was the notice delivered to the defendant(s)']);
                echo render_select('p_noinspection_reason', array(['id' => 'Not applicable', 'name' => 'Posting On the Door'], ['id' => 'Property is exempt', 'name' => 'Sent Via Email'], ['id' => 'Tenant refused to access or vacate', 'name' => 'Hand-Delivered to the tenant and residence over the age of 16']), ['id', 'name'], _l('Manner of Delivery'));
            ...
            <!-- 2nd SendPage -->
            <section id="eviction_filling_admin_b">
              <h4 class="text-center">Tenant Information</h4> <br />
              <div class="row">
                <div class="col-md-6">
                  <?php
                  echo render_input('t_name_one', 'Plaintiff Owner (if applicable): *', '', '', ['placeholder' => 'Plaintiff Owner (if applicable) *']);
                  echo render_input('t_contact_one', 'Plaintiff Phone number', '', 'number', ['placeholder' => 'Plaintiff Phone number']);
                ...
                <div class="col-md-6">
                  <?php
                  echo render_input('t_dob_one', 'Plaintiff Name', '', '', ['placeholder' => 'Plaintiff Name']);
                  echo render_input('t_email_one', 'Plaintiff E-mail', '', 'email', ['placeholder' => 'Plaintiff E-mail']);
              ...
              <div class="row">
                <div class="col-sm-6">
                  <?php
                  echo render_input('t_city', 'Plaintiff City *', '', '', ['placeholder' => 'Plaintiff City*']);
                  echo render_input('t_state', 'Plaintiff State *', '', '', ['placeholder' => 'Plaintiff State*']);
                  echo render_input('t_name_two', 'Filer Business Name', '', '', ['placeholder' => 'Filer Business Name']);

                  echo render_select('t_rental_license_confirm', array(['id' => 'Yes', 'name' => 'Sample C2C Attorney '], ['id' => 'No', 'name' => 'Sample C2C Attorney2 ']), ['id', 'name'], _l('Attorney Name *'),);
                  ?>
                </div>
                ...
                <div class="col-sm-6">
                  ...
                  echo render_input('t_zip', 'Plaintiff Zip Code *', '', '', ['placeholder' => 'Plaintiff Zip Code *']);
                  ...
                  echo render_input('t_rental_license', 'Care Of (if applicable)', '', '', ['placeholder' => 'Care Of (if applicable)']);
                  echo render_input('t_tenant_portion', 'Is plaintiff seeking Attorney fees?', '', '', ['placeholder' => 'Is plaintiff seeking Attorney fees?']);
                  ?>
                </div>
              </div>
            ...
            <!-- 3rd Third Page -->
            <section id="eviction_filling_admin_c">
            ...
            <section id="eviction_filling_admin_d">
              ...
              <div class="row">
                <div class="col-md-6">
                  <?php echo render_select('c_title', array(
                    ['id' => 'Owner', 'name' => 'Owner'], ['id' => 'Property Manager', 'name' => 'Property Manager'], ['id' => 'Attorney', 'name' => 'Attorney'], ['id' => 'Relative', 'name' => 'Relative'], ['id' => 'Other', 'name' => 'Other']
                  ), ['id', 'name'], _l('Title *'),);  ?>
                </div>
                <div class="col-md-6">
...
<script>
  ...
  $("#next").click(function() {
    $("#eviction_filling_admin").validate({
      rules: {
        //   o_fname: "required",
        //   o_lname: "required",
        //   o_pcontact: "required",
  ...
  $(document).ready(function() {
    ...
    $(".button").click(function() {
      ...
      var id = $(this).attr("id");
      if (id == "next") {
        if ($("#eviction_filling_admin").valid()) {
          ...
          if (child >= length) {
            ...
            $(function() {
              $('body').on('click', 'button #submit', function() {
                $('form#eviction_filling_admin').submit();
                console.log("Helloo");
              });
            });
          }
