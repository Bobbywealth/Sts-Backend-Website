...
class Clients_model extends App_Model
{
    ...
    */
    ...
    public function eviction_filling ($postdata){
        $this->db->insert(db_prefix() . 'eviction_filling', $postdata);
         return $this->db->insert_id();
     }
     public function physical_eviction ($postdata){
         $this->db->insert(db_prefix() . 'physical_eviction', $postdata);
         return $this->db->insert_id();
         
      }
      public function other_services ($postdata){
          $this->db->insert(db_prefix().'other_services', $postdata);
          return $this->db->insert_id();
      }
